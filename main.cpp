...
int main(){
    ...
    do{
        ...
        case 1:
        {
            ...
            total_time = duration_selection.count() / 1'000'000.0;
        }
            break;
        case 2:
        {
            ...
            auto duration_insertion = std::chrono::duration_cast<std::chrono::microseconds>(stop_insertion - start_insertion);
            total_time = duration_insertion.count() / 1'000'000.0;
        }
            break;
        case 3:
        {
            ...
            auto duration_bubble = std::chrono::duration_cast<std::chrono::microseconds>(stop_bubble - start_bubble);
            total_time = duration_bubble.count() / 1'000'000.0;
        }
            break;
        case 4:
        {
            ...
            auto duration_quick = std::chrono::duration_cast<std::chrono::microseconds>(stop_quick - start_quick);
            total_time = duration_quick.count() / 1'000'000.0;
        }
            break;
        case 5:
        {
            ...
            auto duration_merge = std::chrono::duration_cast<std::chrono::microseconds>(stop_merge - start_merge);
            total_time = duration_merge.count() / 1'000'000.0;
        }
            break;
        case 6:
        {
            ...
            total_time = duration_counting.count() / 1'000'000.0;
        }
            break;
        case 7:
        {
            ...
            total_time = duration_sort.count() / 1'000'000.0;
        }
            break;    
        }
